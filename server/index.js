...
if (isRealSupabase) {
  console.log(
    "Backend running in Real Supabase Mode connecting to:",
  ...
  console.log(
    "Backend running in Local Sandbox Simulation Mode (sandbox_db.json)",
  );
}
...
app.post("/api/mpesa/callback", async (req, res) => {
  console.log(
    "Tuma Pay Webhook Callback payload received:",
