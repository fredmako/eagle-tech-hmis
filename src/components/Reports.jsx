    ...
    <div className="space-y-6">
      ...
      <div className="mt-4 p-4 rounded-xl border border-slate-800 bg-slate-950/60">
        <div className="flex items-center justify-between mb-2">
          <h4 className="text-[10px] text-teal-400 font-bold uppercase tracking-wider">AI Report Writer</h4>
          <button
            type="button"
            onClick={handleAiWriteReport}
          ...
          >
            {aiReportLoading ? 'Writing Report...' : 'AI Write Report'}
          </button>
        </div>
        ...
        {aiReportResult && (
          <div className="mt-3 space-y-2">
            ...
            <button
              type="button"
              onClick={() => navigator.clipboard.writeText(aiReportResult)}
