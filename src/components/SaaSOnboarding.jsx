                ...
                <div className="bg-teal-500/5 border border-teal-500/20 p-3.5 rounded-lg flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="truncate">
                      <span className="font-bold text-slate-200 block leading-snug font-sans">Authenticated with Google</span>
                      <span className="text-[10px] text-slate-450 block font-medium truncate font-sans">{adminEmail}</span>
                    </div>
                  </div>
                  <button
                    type="button"
